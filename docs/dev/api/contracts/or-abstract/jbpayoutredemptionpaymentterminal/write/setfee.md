...
1.  Make sure the proposed fee is less than the max fee.
    ...
    * [`_FEE_CAP`](/dev/api/contracts/or-abstract/jbpayoutredemptionpaymentterminal/properties/-_fee_cap.md)
2.  Store the new fee.
...
3.  Emit a `SetFee` event with the relevant parameters.
    ...
    * [`SetFee`](/dev/api/contracts/or-abstract/jbpayoutredemptionpaymentterminal/events/setfee.md)
...
| Name                                | Data                                                                           |
| ----------------------------------- | ------------------------------------------------------------------------------ |
| [**`SetFee`**](/dev/api/contracts/or-abstract/jbpayoutredemptionpaymentterminal/events/setfee.md)                                                 | <ul><li><code>uint256 fee</code></li><li><code>address caller</code></li></ul>                                                                                                                                                                                                                                            |
