...
1.  Set the default splits project ID if it has changed.
    ...
    * [`defaultSplitsProjectId`](/api/contracts/jbetherc20splitspayer/properties/defaultsplitsprojectid.md)
2.  Set the default splits domain if it has changed.
    ...
    * [`defaultSplitsDomain`](/api/contracts/jbetherc20splitspayer/properties/defaultsplitsdomain.md)
3.  Set the default splits group if it has changed.
    ...
    * [`defaultSplitsGroup`](/api/contracts/jbetherc20splitspayer/properties/defaultsplitsgroup.md)
6.  Emit a `SetDefaultSplits` event with all relevant parameters.
    ...
    * [`SetDefaultSplits`](/api/contracts/jbetherc20splitspayer/events/setdefaultsplits.md)
