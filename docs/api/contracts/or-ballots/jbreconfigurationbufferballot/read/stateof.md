...
Interface: [`IJBFundingCycleBallot`](/protocol/api/contracts/interfaces/ijbreconfigurationbufferballot)
...
* The function overrides a function definition from the [`IJBFundingCycleBallot`](/protocol/api/interfaces/ijbfundingcycleballot.md) interface.
