...
* [`JBSingleTokenPaymentTerminalStore`](/api/contracts/jbsingletokenpaymentterminalstore/README.md) manages balance accounting data on payment terminals' behalf.
