...
Contract: [`JBSingleTokenPaymentTerminalStore`](/protocol/api/contracts/or-abstract/jbpayoutredemptionpaymentterminal/README.md)​‌
...
1.  Forward to the internal function.
    ...
    * [`_distributePayoutsOf`](/protocol/api/contracts/or-abstract/jbpayoutredemptionpaymentterminal/write/-_distributepayoutsof.md)
